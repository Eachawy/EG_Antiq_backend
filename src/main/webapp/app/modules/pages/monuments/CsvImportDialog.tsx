...
const CsvImportDialog: React.FC<CsvImportDialogProps> = ({
  ...
  const downloadTemplate = () => {
    ...
    const csvContent = `monumentNameAr,monumentNameEn,monumentBiographyAr,monumentBiographyEn,lat,lng,image,startDate,endDate,startDateHijri,endDateHijri,artifactRegistrationNumber,monumentsTypeId,eraId,dynastyId,zoom,center,descriptionEn,descriptionAr
معبد الكرنك,Karnak Temple,معبد الكرنك هو مجمع معابد ضخم,The Karnak Temple Complex comprises a vast mix of decayed temples,25.718833,32.657444,uploads/monuments/karnak.jpg,2560 BC,2540 BC,15/03/1446,20/05/1446,SCA-2024-001,1,1,1,11,25.718833;32.657444,Temple description in English,وصف المعبد بالعربية`;
  ...
  return (
    ...
    >
      <div className="space-y-5 pt-4">
        ...
        <Message
          severity="info"
          text="Required columns: monumentNameAr, monumentNameEn, monumentBiographyAr, monumentBiographyEn, lat, lng, image, startDate, monumentsTypeId, eraId, dynastyId, zoom, center. Optional: endDate, startDateHijri, endDateHijri, artifactRegistrationNumber, descriptionEn, descriptionAr"
          className="mb-4"
        />
